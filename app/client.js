...
import {syncHistoryWithStore} from 'react-router-redux' // 对传统history的增强，可以将history变更数据放入store中
...
const historyWithStore = syncHistoryWithStore(hashHistory, store) // 将history中的location变更同步到store中
