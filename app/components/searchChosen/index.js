...
export default class searchChosen extends Component {
    ...
    getList() {
        ...
        switch (this.props.searchType.toString()) {
            case '1':
                ...
                break;
            case '5':
                list = this.state.riderList;
                break;
            case '10':
                list = this.state.staffList;
                break;
            case '20':
                list = this.state.shopList;
                break
    ...
    search(value) {
        ...
        switch (this.props.searchType.toString()) {
            case '1' :
                newValue.length && createAjax('/common/shop-search', {
                ...
                break;
            case '5':
                newValue.length && createAjax('/common/rider-search', {
                    cityId: this.props.cityId,
                    key: newValue
                }, (result) => {
                ...
                break;
            case '10':
                newValue.length && createAjax('/common/staff-search', {
                    cityId: this.props.cityId,
                    key: newValue
                }, (result) => {
